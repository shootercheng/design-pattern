...
import com.scd.singleton.lazy.LazyMtSingleton;
    ...
    private Thread createThread(int i) {
        Thread thread = new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    cyclicBarrier.await();
                    LazyMtSingleton lazySingleton = LazyMtSingleton.getLazySingletonInstance();
                    System.out.println(Thread.currentThread().getName() + "---" + System.currentTimeMillis() + "---" +lazySingleton);
